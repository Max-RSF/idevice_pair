...
This desktop app will help you generate a pairing key, which is necessary to use the iOS-QF app.
Please run this only on a trusted computer.

To generate a pairing key, click Next.
                        ");
